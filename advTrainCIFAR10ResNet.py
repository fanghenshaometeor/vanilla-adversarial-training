...
def main():
    ...
    # ======== parameter settings =======
    parser = argparse.ArgumentParser(description='Adversarial Training ResNet on CIFAR10')
    # -------- file param. --------------
    ...
    # --------
    parser.add_argument('--val-ratio', type=float, default=0.2, metavar='VALIDATION_SET_RATIO',
